...
$(document).on('page:change', function() {
	initialize();
	if (typeof(tripDetails) !== 'undefined') { calcRoute(); }
});
...
function initialize() {
  ...
  var mapOptions = {
    zoom: 8,
    center: new google.maps.LatLng(40.397, -75.644)
      //zoomControl: true,
    // zoomControlOptions: {
...
function calcRoute() {
  var start = tripDetails.start_address;
  var end = tripDetails.finish_address;
  var request = {
    origin: start,
    destination: end,
